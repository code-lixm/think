...
export const IconDrawPanel: React.FC<{ style?: React.CSSProperties }> = ({ style = {} }) => {
  return (
    <Icon
      style={style}
      svg={
        <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
          <path d="M822.4 432.7m-69.8 0a69.8 69.8 0 1 0 139.6 0 69.8 69.8 0 1 0-139.6 0Z" fill="currentColor"></path>
          <path d="M647.8 231.8m-69.8 0a69.8 69.8 0 1 0 139.6 0 69.8 69.8 0 1 0-139.6 0Z" fill="currentColor"></path>
          <path d="M372.3 262.7m-69.8 0a69.8 69.8 0 1 0 139.6 0 69.8 69.8 0 1 0-139.6 0Z" fill="currentColor"></path>
          <path d="M221 498.4m-69.8 0a69.8 69.8 0 1 0 139.6 0 69.8 69.8 0 1 0-139.6 0Z" fill="currentColor"></path>
          <path
